...
// public class CounterBlockEntityRenderer implements
// BlockEntityRenderer<CounterBlockEntity> {
...
// @Override
// public void render(CounterBlockEntity entity, float tickDelta, MatrixStack
// matrices,
...
// textRenderer.draw(
// text, -width / 2, -4f, 0xffffff, false, matrices.peek().getPositionMatrix(),
// vertexConsumers,
